...
def model(q_train, q_dev, q_val, a_train, a_dev, a_val, qdict, adict, path2outdir):
    ...
    quest_model.add(LSTM(output_dim=300, init='glorot_uniform', inner_init='orthogonal', activation='tanh',
                         inner_activation='hard_sigmoid', W_regularizer=None, U_regularizer=None, b_regularizer=None,
